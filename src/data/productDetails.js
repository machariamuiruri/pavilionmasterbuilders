...
export const productDetails = {
  ...
  'a-frame-structures': {
    ...
    // A-Frame is the one product with no card in src/data/products.js, so the
    // /products/ index builds its card from here and needs real alt text for
    // the hero image. Optional everywhere else.
    heroAlt: 'Steel-framed A-Frame cabin under construction, viewed from the gable end',
